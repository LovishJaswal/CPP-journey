...
using namespace std;
    ...
    //Functions declaration for the operations

    float Addition(float a, float b){                            //Addition
        return a + b;
    }

    float Subtraction(float a, float b){                         //Subtraction
        return a - b;
    }

    float Multiplication(float a, float b){                      //Multiplication
        return a * b;
    }
    ...
    float Modulus(float a, float b) {                             //Modulus
      if (b != 0)
        return fmod(a, b);
      else {
    ...
    void Calculator(float num1, float num2){
        ...
        cout << "7. Square Root (√n): Only first number will be considered for input, second will be ignored\n";
        cout << "8. Factorial (n!): Only first number will be considered for input, second will be ignored\n";
